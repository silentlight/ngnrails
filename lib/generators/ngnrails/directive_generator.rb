module Ngnrails
  class DirectiveGenerator < Rails::Generators::NamedBase
    ...
    def check_existing_directive
      if File.exist? "app/assets/javascripts/ng/apps/#{singular_name.underscore.downcase}/directive/#{@ng_directive_name.underscore.downcase}.js"
        puts "Directive #{@ng_directive_name} in #{singular_name.underscore.downcase} application already exists!"
        exit!
      end
    end
    ...
    def create_directive_file
      ...
      if template.blank? || template == 'n'
        ...
        @template_url = "/ng/apps/#{singular_name}/templates/directives/#{@ng_directive_name.underscore.dasherize.downcase}/#{template_name}"
      end

      @module_name = @ng_directive_name.underscore.camelize(:lower)
      template("app/assets/javascripts/ng/apps/directive_template.js.erb", "app/assets/javascripts/ng/apps/#{singular_name}/directives/#{@ng_directive_name.underscore.camelize}.js")
    ...
    def create_ng_view
      ...
      if @template_url
        if @template_type == VIEW_TYPE_DYNAMIC
          ...
          # Add route
          insert_into_file "config/routes.rb", :after => "# Ng::Apps::#{class_name}::Templates::Directives\n" do
            "
          ...
          # Add controller
          @controller_namespace = "Apps::" + class_name
          @controller_name = @ng_directive_name.underscore.camelize
          template('app/controllers/ng/apps/directives_controller_template.rb.erb', "app/controllers/ng/apps/#{singular_name.underscore.downcase}/templates/directives/#{@ng_directive_name.underscore.downcase}_controller.rb")

          # Add view file
          copy_file "app/views/ng/apps/templates/dynamic_directive_template_example.html.erb", "app/views/ng/apps/#{singular_name.underscore.downcase}/templates/directives/#{@ng_directive_name.underscore.downcase}/#{@template_name.underscore.downcase}.html.erb"

        else
          copy_file "public/ng/apps/templates/static_directive_template_example.html", "public/ng/apps/#{singular_name.underscore.downcase}/templates/directives/#{@ng_directive_name.underscore.downcase}/#{@template_name.underscore.downcase}.html"
        end
      end
